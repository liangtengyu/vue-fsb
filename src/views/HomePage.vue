    ...
    <a-row :gutter="8" class="count-info">
      ...
      <a-col :span="12" class="project-wrapper">
        <a-card title="进行中的项目" class="project-card">
          <a href="https://github.com/liangtengyu" target="_blank" slot="extra">所有项目</a>
          <table>
            <tr>
              <td>
  ...
  data () {
    return {
      ...
      projects: [
        {
          name: 'Fsb',
          des: '基于Spring Boot 2.0.4 & Shiro  的快速脚手架',
          avatar: 'F'
        },
        {
          name: 'Fsb-Vue',
          des: 'Fsb 前端架构 -采用Vue全家桶。',
          avatar: 'F'
        },
        {
          name: 'MyBlog',
          des: '使用jekyll + gitPage 搭建的blog',
          avatar: 'M'
        }
      ],
      todayIp: '',
